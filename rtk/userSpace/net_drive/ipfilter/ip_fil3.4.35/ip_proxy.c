...
#if !defined(lint)
static const char rcsid[] = "@(#)$Id: ip_proxy.c,v 1.5 2010-08-27 03:45:55 Exp $";
#endif
...
#ifdef TENDA_WLJB
#include "netinet/ip_http_pxy.c"
#endif
#include "netinet/ip_pptp_pxy.c"
#include "netinet/ip_l2tp_pxy.c"

#ifdef IPF_RTSP_PROXY
//added by liuzexin
#include "netinet/ip_rtsp_pxy.c"
#endif
...
aproxy_t	ap_proxies[] = {
#ifdef	IPF_FTP_PROXY
	{ NULL, "ftp", (char)IPPROTO_TCP, 21, 0, 0, ippr_ftp_init, NULL,
	  ippr_ftp_new, NULL, ippr_ftp_in, ippr_ftp_out, NULL },
#endif

//added by liuzexin 20012/04/19
#ifdef	IPF_RTSP_PROXY
	{ NULL, "rtsp", (char)IPPROTO_TCP, 554, 0, 0, ippr_rtsp_init, NULL,
	 ippr_rtsp_new, NULL, NULL, ippr_rtsp_out, NULL },
#endif

#ifdef	IPF_RCMD_PROXY
	{ NULL, "rcmd", (char)IPPROTO_TCP, 0, 0, 0, ippr_rcmd_init, NULL,
	  ippr_rcmd_new, NULL, NULL, ippr_rcmd_out, NULL },
#endif
#ifdef	IPF_RAUDIO_PROXY
	{ NULL, "raudio", (char)IPPROTO_TCP, 0, 0, 0, ippr_raudio_init, NULL,
	  ippr_raudio_new, NULL, ippr_raudio_in, ippr_raudio_out, NULL },
#endif
#ifdef IPF_IPSEC_PROXY
	{ NULL, "ipsec", (char)IPPROTO_UDP, 500, 0, 0, ippr_ipsec_init, NULL,
	  ippr_ipsec_new, ippr_ipsec_del, NULL, ippr_ipsec_out,
	  ippr_ipsec_match },
#endif
#ifdef	IPF_NETBIOS_PROXY
	{ NULL, "netbios", (char)IPPROTO_UDP, 0, 0, 0, ippr_netbios_init, NULL,
	  NULL, NULL, NULL, ippr_netbios_out, NULL },
#endif
#ifdef	IPF_PPTP_PROXY
	{ NULL, "pptp", (char)IPPROTO_TCP, 1723, 0, 0, ippr_pptp_init, NULL,
 	  ippr_pptp_new, ippr_pptp_del, ippr_pptp_in, ippr_pptp_out, NULL },
#endif
#ifdef IPF_L2TP_PROXY 
	{ NULL, "l2tp", (char)IPPROTO_UDP, 1701, 0, APR_DONOTCHANGEPORT, ippr_l2tp_init, NULL,
	  ippr_l2tp_new, NULL, NULL, NULL, ippr_l2tp_match },      
#endif
#ifdef  IPF_H323_PROXY
    { NULL, "h323", (char)IPPROTO_TCP, 1720, 0, 0, ippr_h323_init, NULL,
 	  ippr_h323_new, ippr_h323_del, ippr_h323_in, ippr_h323_out, NULL },
    { NULL, "h245", (char)IPPROTO_TCP, 0, 0, 0, ippr_h245_init, NULL,
 	  ippr_h245_new, NULL, NULL, ippr_h245_out, NULL },
#endif   
#ifdef TENDA_WLJB
	{ NULL, "http", (char)IPPROTO_TCP, 80, 0, 0, ippr_http_init, NULL,
 		  NULL, NULL, NULL, ippr_http_out, NULL },
#endif
