 ...
 *
 * $Id: ip_proxy.h,v 1.3 2010-08-27 03:45:55 Exp $
 */
...
extern	int	appr_new __P((fr_info_t *, ip_t *, struct nat *, aproxy_t *));
extern	aproxy_t * appr_find(int prot, unsigned short port);
