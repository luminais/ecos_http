 ...
 *
 * @(#)ip_nat.h	1.5 2/4/96
 * $Id: ip_nat.h,v 1.9 2010-08-27 03:45:55 Exp $
 */
...
#define	SIOCRUPDATENATMSS	_IOW('r', 100, int)
#endif
...
typedef	struct	ipnat	{
	...
	char	in_p;	/* protocol */
	u_short	in_autofwport[2];	/* autofw ports [min]-[max] */
	u_short in_autofwp;		/* autofw protocol */
	u_int	in_autofwuse;		/* autofw rule activated */
	u_int	in_autofwage;		/* aging for autofw entry */
	struct	ipnat	*in_autofwnext;
} ipnat_t;
...
#define in_autofwpmin	in_autofwport[0]
#define in_autofwpmax	in_autofwport[1]
...
#define IPN_FASTCACHE	0x01000000
#define IPN_AUTOFW	0x02000000
