 ...
 * $Id: ip_compat.h,v 1.2 2010-05-05 11:43:46 Exp $
 */
...
#if defined(__FreeBSD_version) && (__FreeBSD_version >= 500000) && defined(_KERNEL)
...
#  if defined(__FreeBSD_version) && (__FreeBSD_version >= 400000) && \
	!defined(KLD_MODULE) && !defined(__ECOS)
#   include "opt_inet6.h"
#  endif
#  ifdef INET6
#   define USE_INET6     
...
#  if (defined(__FreeBSD_version) && (__FreeBSD_version >= 400000) && !defined(NOINET6) \
	&& !defined(__ECOS)) || (defined(OpenBSD) && (OpenBSD >= 200111)) || \
...
#  if (defined(__NetBSD_Version__) && (__NetBSD_Version__ < 105180000)) || \
	(defined(__FreeBSD__) && !defined(__ECOS)) || (defined(OpenBSD) && (OpenBSD < 200206)) \
...
typedef	struct	{
	...
	__u32	th_seq;
	__u32	th_ack;
# if defined(__i386__) || defined(__MIPSEL__) || defined(__alpha__) || defined(__vax__)
	__u8	th_res:4;
	__u8	th_off:4;
#else
	__u8	th_off:4;
