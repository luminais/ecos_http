 ...
 */
	...
	#define HTTP_DEBUG_OFF		0
	#define HTTP_DEBUG_ERROR	1
	extern int HTTPDebugLevel;
	#define HTTP_DBGPRINT(Level, fmt, args...)   \
	{                                           \
	    if (Level <= HTTPDebugLevel)                      \
	    {                                       \
...
#define SOCKET_CONNECT_TIMEOUT  2			
#define SOCKET_CONNECT_RW_TIMEOUT 30	
#define IS_SERVER_LISTEN_HANDLE 0x123456	
