...
USER_OBJ   = $(OUTDIR)/mem.o $(OUTDIR)/mem_clr.o $(OUTDIR)/bn_add.o $(OUTDIR)/bn_asm.o $(OUTDIR)/bn_const.o $(OUTDIR)/bn_ctx.o \
		...
		$(OUTDIR)/md4_dgst.o $(OUTDIR)/md4_one.o \
		$(OUTDIR)/des_enc.o $(OUTDIR)/ecb_enc.o $(OUTDIR)/set_key.o $(OUTDIR)/des_old.o 
...
######################./Crypto/md4/#####################################
$(OUTDIR)/md4_dgst.o: ./crypto/md4/md4_dgst.c
	$(CC) -c $(CFLAGS) -o $(OUTDIR)/md4_dgst.o ./crypto/md4/md4_dgst.c

$(OUTDIR)/md4_one.o: ./crypto/md4/md4_one.c
	$(CC) -c $(CFLAGS) -o $(OUTDIR)/md4_one.o ./crypto/md4/md4_one.c
######################./Crypto/des/#####################################
$(OUTDIR)/des_enc.o: ./crypto/des/des_enc.c
	$(CC) -c $(CFLAGS) -o $(OUTDIR)/des_enc.o ./crypto/des/des_enc.c
$(OUTDIR)/ecb_enc.o: ./crypto/des/ecb_enc.c
	$(CC) -c $(CFLAGS) -o $(OUTDIR)/ecb_enc.o ./crypto/des/ecb_enc.c
$(OUTDIR)/set_key.o: ./crypto/des/set_key.c
	$(CC) -c $(CFLAGS) -o $(OUTDIR)/set_key.o ./crypto/des/set_key.c
$(OUTDIR)/des_old.o: ./crypto/des/des_old.c 
	$(CC) -c $(CFLAGS) -o $(OUTDIR)/des_old.o ./crypto/des/des_old.c 
#####################################################################
