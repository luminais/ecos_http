...
var opmode_radio_rpt=' Repeater: ';
var opmode_radio_rpt_explain='In this mode, all ethernet ports and wireless interfaces are bridged together and the NAT function is disabled. Repeater interface will used to connect to other access point. ';
...
var wlsec_explain = ' This page allows you to setup wireless security. Using WEP or WPA Encryption Keys will help prevent unauthorized access to your wireless network.';
...
var wizard_wpa2_mixed = 'WPA Mixed';
...
var opmode_radio_gw_explain_cmj='In this mode, the device connects to the internet via an ADSL/Cable Modem. NAT is enabled and PCs on LAN ports share the same IP to the ISP via the WAN port. The connection type is DHCP client.';
...
/***********	OK_MSG ************/
var okmsg_explain = "<body><blockquote><h2>Changed setting successfully!</h2><font size=\"2\">Your changes have been saved. The router must be rebooted for the changes to take effect.<br> You can reboot now, or you can continue to make other changes and reboot later.\n</font>";
