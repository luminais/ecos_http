...
//    struct in_addr old_ipaddr;
    ...
    {
//    old_ipaddr.s_addr= ((struct sockaddr_in *)&ifr.ifr_addr)->sin_addr.s_addr;
//    diag_printf("%s:%d ip_addr=%s\n",__FUNCTION__,__LINE__,inet_ntoa(old_ipaddr));
