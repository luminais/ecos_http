...
function MTMAddItem() {
	if(arguments[0].toString().indexOf("[object Object]") != -1) {
		...
		this.items[this.items.length] = new MTMenuItem(arguments[0], arguments[1], arguments[2], arguments[3]);
	}
}
...
var MTMenuText = menu_site, MTMRootIcon = "menu_root.gif", MTMRootColor = "#FFFFFF";

var MTMRootFont = "Arial, Helvetica, sans-serif, bold";
var	MTMenuFont = MTMRootFont;
// david
