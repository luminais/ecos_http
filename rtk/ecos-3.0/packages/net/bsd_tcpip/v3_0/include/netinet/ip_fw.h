 ...
 */
#define RTL_EXTEND_FIREWALL_SUPPORT_IP_RANGE 1
union ip_fw_if {
    struct in_addr fu_via_ip;	/* Specified by IP address */
    struct {			/* Specified by interface name */
#define FW_IFNLEN     12 /* need room ! was IFNAMSIZ */
	    char  name[FW_IFNLEN];
...
struct ip_fw {
	...
	u_char	ether_src[ETHER_ADDR_LEN];	/*source mac address*/
	u_char	ether_dst[ETHER_ADDR_LEN];	/*dest mac address*/
    u_short fw_number;			/* Rule number */    
    #ifdef RTL_EXTEND_FIREWALL_SUPPORT_IP_RANGE    
    u_int64_t fw_flg;			/* Flags word */
    #else
...
#define IP_FW_ICMPTYPES_DIM	(IP_FW_ICMPTYPES_MAX / (sizeof(unsigned) * 8))
	...
	u_char fw_url[MAX_URL_LEN];			/*url to filter*/
...
#ifdef RTL_EXTEND_FIREWALL_SUPPORT_IP_RANGE
#define fw_srcipaddr_start fw_src.s_addr
#define fw_dstipaddr_start fw_dst.s_addr
#define fw_srcipaddr_end fw_smsk.s_addr
#define fw_dstipaddr_end fw_dmsk.s_addr
#endif
...
#define IP_FW_F_URL	0x00200000	/* filter by URL			*/
#define IP_FW_F_DMAC	0x00400000	/* filter by DST MAC	*/
...
#define IP_FW_F_SMAC	0x80000000	/* SRC MAC */
#ifdef RTL_EXTEND_FIREWALL_SUPPORT_IP_RANGE
#define IP_FW_F_SRCIP_RANGE 0x100000000LL   /* source ip ranged */
#define IP_FW_F_DSTIP_RANGE 0x200000000LL   /* destination ip ranged */
#endif
#ifdef RTL_EXTEND_FIREWALL_SUPPORT_IP_RANGE
#define IP_FW_F_MASK	0xFFFFFFFFFFFFFFFFLL	/* All possible flag bits mask		*/
#else
