 ...
 * IRQ Mapping
 */
//#define BSP_IRQ_ICTL_MASK       0xFFDF6EFF
#define BSP_IRQ_ICTL_MASK       (~(BSP_TC0_IE|BSP_PCIE_IE|BSP_PCIE2_IE|BSP_SW_IE|BSP_UART0_IE))
#define BSP_TC0_IRQ		(BSP_IRQ_CPU_BASE + 4) //IP7
#define BSP_TC1_IRQ		(BSP_IRQ_ICTL_BASE + 9)
#define BSP_UART0_IRQ           (BSP_IRQ_CPU_BASE + 0) //IP3
#define BSP_UART1_IRQ           (BSP_IRQ_ICTL_BASE + 13)
#define BSP_SWCORE_IRQ          (BSP_IRQ_CPU_BASE + 1) //IP4
#define BSP_SW_IRQ				BSP_SWCORE_IRQ
...
#define BSP_PCIE_IRQ            (BSP_IRQ_CPU_BASE + 3) //IP6
#define BSP_PCIE2_IRQ           (BSP_IRQ_CPU_BASE + 2) //IP5
#define BSP_GDMA_IRQ            (BSP_IRQ_ICTL_BASE + 23)
#define BSP_CPU_WAKEUP_IRQ      (BSP_IRQ_ICTL_BASE + 27)
