...
#define BSP_PCIE_IRQ		(BSP_IRQ_CPU_BASE + 3) //21
#define BSP_GPIO_ABCD_IRQ	16
#define BSP_SW_IRQ		(BSP_IRQ_CPU_BASE + 2) //15
#define BSP_USB_IRQ		(BSP_IRQ_CPU_BASE + 1) //11
