...
#define BSP_GIMR2            0xB8003020
   #define BSP_SITIMER_IE      (1 << 17)

#define BSP_GISR2            0xB8003024
   #define BSP_SITIMER_IP      (1 << 17)

/*
 *   RTL819x Interrupt Scheme (Subject to change)
 *                       (CPU:2~7,LOPI:8~15)
 *   Source       bit#         RS              IRQ      
 *   --------   -------  -------------------  ------   
 *   TC0            8           7             32+4
 ...
 * IRQ Mapping
 */
#define BSP_IRQ_ICTL_MASK       (~(BSP_TC0_IE|BSP_WLAN_MAC_IE|BSP_PCIE_IE|BSP_SW_IE|BSP_UART0_IE))
#ifdef CONFIG_RTL_819X_INTERNAL_TIMER
#define BSP_TC0_IRQ		8
#else
#define BSP_TC0_IRQ		(BSP_IRQ_CPU_BASE + 4)  //8
#endif
#define BSP_TC1_IRQ		9
#define BSP_UART0_IRQ           (BSP_IRQ_CPU_BASE + 0) //12
...
#ifdef CONFIG_RTL_819X_INTERNAL_TIMER
#define BSP_SITIMER_IRQ		(BSP_IRQ_CPU_BASE + 4)	//for test
#endif
...
#ifdef CONFIG_RTL_819X_INTERNAL_TIMER
#define BSP_TC0_RS		BSP_IRQ_ZER0
#else
#define BSP_TC0_RS		7
#endif
#define BSP_TC1_RS		BSP_IRQ_ZER0
#define BSP_USB_H_RS		BSP_IRQ_ZER0
#define BSP_OTG_RS		BSP_IRQ_ZER0
...
#define BSP_WLAN_MAC_RS		6

#define BSP_GISR2_RS            BSP_IRQ_ZER0

#ifdef CONFIG_RTL_819X_INTERNAL_TIMER
#define BSP_SITIMER_RS		7	//for test
#else
#define BSP_SITIMER_RS		BSP_IRQ_ZER0
#endif
...
#define BSP_IRR3_SETTING    ((BSP_GISR2_RS << 28) | \
                         (BSP_NONE_RS << 24) | \
                         (BSP_WLAN_MAC_RS << 20) | \
                         (BSP_NONE_RS << 16) | \
...
#define BSP_IRR4_SETTING    ((BSP_NONE_RS << 28) | \
                         (BSP_NONE_RS << 24) | \
                         (BSP_NONE_RS << 20) | \
                         (BSP_NONE_RS << 16) | \
                         (BSP_NONE_RS << 12) | \
...
#define BSP_IRR5_SETTING    ((BSP_NONE_RS << 28) | \
                         (BSP_NONE_RS << 24) | \
                         (BSP_NONE_RS << 20) | \
                         (BSP_NONE_RS << 16) | \
                         (BSP_NONE_RS << 12) | \
...
#define BSP_IRR6_SETTING    ((BSP_NONE_RS << 28) | \
                         (BSP_NONE_RS << 24) | \
                         (BSP_NONE_RS << 20) | \
                         (BSP_NONE_RS << 16) | \
                         (BSP_NONE_RS << 12) | \
...
#define BSP_IRR7_SETTING    ((BSP_NONE_RS << 28) | \
                         (BSP_NONE_RS << 24) | \
                         (BSP_NONE_RS << 20) | \
                         (BSP_NONE_RS << 16) | \
                         (BSP_NONE_RS << 12) | \
