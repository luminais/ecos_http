...
#if defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8196E)  ||defined(CONFIG_RTL_8197F) 
...
#if defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8881A) || defined(CONFIG_RTL_8197F)
#define RTL8651_MULTICASTTBL_SIZE			256
#define RTL8651_IPMULTICASTTBL_SIZE		256
#define RTL8651_IPMCAST_CAM_SIZE			32

#elif defined(CONFIG_RTL8196C_REVISION_B) || defined(CONFIG_RTL8198) || defined(CONFIG_RTL_819XD)
#define RTL8651_MULTICASTTBL_SIZE			128
#define RTL8651_IPMULTICASTTBL_SIZE		128

#define RTL8651_IPMCAST_CAM_SIZE			32		// CONFIG_RTL_819XD
...
#elif defined (CONFIG_RTL_8197F)//litter endian
    /* word 0 */
    ipaddr_t        srcIPAddr;
    /* word 1 */
    uint32          destIPAddrLsbs : 28;
...
uint32 rtl8651_returnAsicCounter(uint32 offset);//Backward compatable, deprecated
...
#endif
#endif
} rtl819x_tblAsic_ipMulticastv6Table_t;

typedef struct rtl819x_tblAsicDrv_multiCastv6Param_s {
	inv6_addr_t	sip;
	inv6_addr_t	dip;
	uint16	port;
	uint32	mbr;
	...
	uint16	six_rd_eg;
	uint16	six_rd_idx;
} rtl819x_tblAsicDrv_multiCastv6Param_t;
...
extern int rtl819x_setSwEthPvid();
extern int rtl819x_getSwEthPvid(uint32 port, uint32* pvid);
#endif
