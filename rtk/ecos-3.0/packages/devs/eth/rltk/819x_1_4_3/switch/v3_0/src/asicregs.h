...
* All rights reserved.
* 
* $Header: /cvs/AP/rtl865x/linux-2.4.18/drivers/net/rtl865x/asicregs.h,v 1.15 2010/02/24 09:31:45 joeylin Exp $
*
...
/* GCSR0 - Port Congestion Status Register 0 */
...
/* GCSR1 - Port Congestion Status Register 1 */
