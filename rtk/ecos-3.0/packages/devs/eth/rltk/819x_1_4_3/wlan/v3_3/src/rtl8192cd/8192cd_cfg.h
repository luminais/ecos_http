...
#ifdef __CONFIG_TENDA_HIGH_PWR__
#define CONFIG_SLOT_0_EXT_LNA
#define CONFIG_SLOT_0_EXT_PA
#define CONFIG_LNA_TYPE_0
#endif
...
#define CONFIG_RTL_HW_ENC_GROUP_CIPHER
...
#define dybw_thrd	3
	...
	#elif defined(__ECOS) && defined(CYGNUM_RAM_SIZE_0x00800000)
		#if (defined(CONFIG_WLAN_HAL_8814AE) && !defined(CONFIG_RTL_DUAL_PCIESLOT_BIWLAN)) // 8194
			#define NUM_RX_DESC		256
		#else
...
#ifdef CONFIG_DISABLE_PHYDM_DEBUG_FUNCTION
