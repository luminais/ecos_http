...
#define SIOCGICHANNELSCORE		0x8BF9
...
#if defined(HS2_SUPPORT) || defined(DOT11K)	|| defined(UCHAN_SUPPORT)
...
#if defined(DOT11K) || defined(UCHAN_SUPPORT) /*radio measurement*/
...
//PRINT_SINGL_ARG("    dgaf_disable:  ",priv->dgaf_disable, "%d");
	...
	{"adaptivity_enable",		RFFT_T,	_OFFSET_RFFT(adaptivity_enable), _SIZE_RFFT(adaptivity_enable), 2},
	/*Tenda adaptivity mode,default:close,开启可以根据是否有Intel网卡调整adatpivity和dig的值*/
	{"td_adaptivity_mode",		RFFT_T,	_OFFSET_RFFT(td_adaptivity_mode), _SIZE_RFFT(td_adaptivity_mode), 0},
	/*腾达接收灵敏度的大小，BSPLJF++*/	
	...
	{"bws_thd", 	RFFT_T, _OFFSET_RFFT(bws_Thd), _SIZE_RFFT(bws_Thd), 1800},	
    ...
    {"td_FA_UpperBound", 	RFFT_T, _OFFSET_RFFT(td_FA_UpperBound), _SIZE_RFFT(td_FA_UpperBound), 1350},
    {"td_FA_LowerBound", 	RFFT_T, _OFFSET_RFFT(td_FA_LowerBound), _SIZE_RFFT(td_FA_LowerBound), 1000},
    {"td_auto_antiInterferance",    INT_T,		_OFFSET(dot11nConfigEntry.td_auto_antiInterferance), _SIZE(dot11nConfigEntry.td_auto_antiInterferance), 1},
...
// Tx Power Diff
	...
	{"txbf8822", RFFT_T, _OFFSET_RFFT(txbf8822), _SIZE_RFFT(txbf8822), 1},
	{"mutime", RFFT_T, _OFFSET_RFFT(mutime), _SIZE_RFFT(mutime), 20}, 
...
#endif
		{
            panic_printk("NOT 92D, NOT support 5G\n");
		}
...
case DO_KFREE:
	...
	case SIOC11VBSSTRANSREQ:
		if ((wrq->u.data.length < sizeof(struct bss_transition_para)) || ioctl_copy_from_user(tmpbuf, (void *)wrq->u.data.pointer, sizeof(struct bss_transition_para)))
			break;
