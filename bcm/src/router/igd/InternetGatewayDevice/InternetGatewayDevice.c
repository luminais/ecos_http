 ...
 *
 * $Id: InternetGatewayDevice.c 241182 2011-02-17 21:50:03Z gmo $
 */
#include <upnp.h>
#include <InternetGatewayDevice.h>

/* Tneda added for debug */
#define UPNP_AUTONAT_LIMIT		64
/* end add */
...
)
{
	...
	/* add by tenda for limit auto NAT rules */
	if (igd_ctrl->pm_num >= UPNP_AUTONAT_LIMIT)
		return 0;
	/* end add */
