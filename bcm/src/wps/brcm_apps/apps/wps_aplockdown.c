 ...
 *
 * $Id: wps_aplockdown.c 241182 2011-02-17 21:50:03Z gmo $
 */
...
wps_aplockdown_check(void)
{
	...
	//diag_printf("%s_%d: now=%d ageout=%d init_ageout=%d\n",__FUNCTION__,__LINE__,now,ageout,wps_aplockdown.init_ageout);
