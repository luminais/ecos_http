 ...
 *
 * $Id: wlc_wpa.h,v 1.7.10.2 2010-10-07 19:28:30 Exp $
 */
...
typedef struct {
	...
	uint8 igtk[BIP_KEY_SIZE+8];	/* integrated group transient key, +8 since AES wrapped */
	uint16 igtk_id;			/* integrated group transient key id */
	uint8 igtk_ipn[6];		/* integrated group transient key IPN */
	ushort igtk_len;		/* Group (mcast) key length */
#endif
} wpapsk_t;
