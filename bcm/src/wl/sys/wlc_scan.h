 ...
 *
 * $Id: wlc_scan.h,v 1.29.2.9 2010-09-21 01:03:02 Exp $
 */
#ifndef _WLC_SCAN_H_
#define _WLC_SCAN_H_
...
extern wlc_scan_info_t* BCMATTACHFN(wlc_scan_attach)(wlc_info_t *wlc, void *wl, osl_t *osh, uint);
extern void BCMATTACHFN(wlc_scan_detach)(wlc_scan_info_t *scan_ptr);
...
extern bool wlc_scan_recv_parse_bcn_prb(wlc_scan_info_t *si, bool beacon, wlc_bss_info_t *bi,
