 ...
 *
 * $Id: wlc_bmac.h,v 1.136.2.43 2011-01-27 19:03:13 Exp $
 */
...
extern int wlc_bmac_dngl_wd_set(wlc_hw_info_t *wlc_hw,
                                   bool dngl_wd, uint32 dngl_wd_exptime);
...
extern int wlc_bmac_set_epa_default_state(wlc_hw_info_t *wlc_hw);
