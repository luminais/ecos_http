 ...
 * $Id: ip_fil.h,v 1.6 2010-11-04 04:06:43 Exp $
 */
 ...
 */
#  define	IPL_NAME	"/dev/net/ipl"
#  define	IPNAT_NAME	"/dev/net/ipnat"
...
#if (defined(NetBSD) && (NetBSD <= 1991011) && (NetBSD >= 199603)) || (defined(OpenBSD) \
	&& (OpenBSD >= 199603))
...
#if !defined(CDEV_MAJOR) && defined(__FreeBSD_version) && (__FreeBSD_version >= 220000)
...
#   endif
#   if (_BSDI_VERSION >= 199510) || ((__FreeBSD_version >= 220000) && !defined(__ECOS)) \
