...
externC cyg_int32 cyg_thread_get_rdrfd(cyg_handle_t thread) __THROW
{
    return ((Cyg_Thread *)thread)->get_rdrfd();
}
externC void cyg_thread_set_rdrfd(cyg_handle_t thread, cyg_int32 rdrfd) __THROW
{
    ((Cyg_Thread *)thread)->set_rdrfd(rdrfd);
}
#endif
