...
#define HAL_DCACHE_INVALIDATE_ALL(_cache_size_)                                         \
    CYG_MACRO_START                                                                     \
    register volatile CYG_BYTE *addr;                                                   \
    HAL_CLEAR_TAGLO();                                                                  \
    HAL_CLEAR_TAGHI();                                                                  \
    for (addr = (CYG_BYTE *)CYGARC_KSEG_CACHED_BASE;                                    \
         addr < (CYG_BYTE *)(CYGARC_KSEG_CACHED_BASE + (_cache_size_));                	\
...
#define HAL_DCACHE_FLUSH( _base_ , _asize_ )						\
    CYG_MACRO_START                                                                     \
    register CYG_WORD _offset_ = ((CYG_WORD)(_base_) & 0x0f);				\
    register CYG_ADDRESS _baddr_ = (CYG_ADDRESS)((_base_)-_offset_);                    \
    register CYG_ADDRESS _addr_ = (CYG_ADDRESS)((_base_)-_offset_);                     \
    register CYG_WORD _size_ = (_asize_)+_offset_;                                      \
...
#define HAL_DCACHE_UNLOCK(_base_, _asize_)	HAL_DCACHE_INVALIDATE((_base_), (_asize_))
...
#define HAL_ICACHE_INVALIDATE_ALL(_cache_size_)                                         \
    CYG_MACRO_START                                                                     \
    register volatile CYG_BYTE *addr;                                                   \
    HAL_CLEAR_TAGLO();                                                                  \
    HAL_CLEAR_TAGHI();                                                                  \
...
#define HAL_ICACHE_UNLOCK(_base_, _asize_)	HAL_ICACHE_INVALIDATE((_base_), (_asize_))
