...
// processor.
#ifndef HAL_IDLE_THREAD_ACTION_DEFINED
#define HAL_IDLE_THREAD_ACTION_DEFINED

externC void hal_variant_idle_thread_action(cyg_uint32 loop_count);

#define HAL_IDLE_THREAD_ACTION(_count_) hal_variant_idle_thread_action(_count_)

#endif	// HAL_IDLE_THREAD_ACTION_DEFINED
