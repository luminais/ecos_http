...
extern cyg_uint32  cyg_splhigh(const char *file, const int line);
extern cyg_uint32  cyg_splinternal(const char *file, const int line);
extern void        cyg_splx(cyg_uint32, const char *file, const int line);
#define splimp()   cyg_splimp((char *)__FUNCTION__, __LINE__)
#define splnet()   cyg_splnet((char *)__FUNCTION__, __LINE__)
#define splclock() cyg_splclock((char *)__FUNCTION__, __LINE__)
#define splsoftnet() cyg_splsoftnet((char *)__FUNCTION__, __LINE__)
#define splhigh() cyg_splhigh((char *)__FUNCTION__, __LINE__)
#define splinternal() cyg_splinternal((char *)__FUNCTION__, __LINE__)
#define splx(x)    cyg_splx(x, (char *)__FUNCTION__, __LINE__)
#if 0
...
#define vsnprintf  diag_vsnprintf
