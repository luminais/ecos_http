...
extern void set_wl_pwr_percent(void);
...
void update_tunnel_firewall(char *pppname);

void firewall_init(void);
void firewall_flush(void);
void firewall_basic_rule(char *wan_ifname);
void ipnat_init(void);
void ipnat_deinit(void);
void ipnat_napt_init(char *wan_ifname);
