...
<body class="login-body" onLoad="init()">
	...
	<div class="container">
		<form name="Login" class="login" method="post" action="/LoginCheck">
			...
			<div class="container">
				<p class="login-massage text-error"><span id="message-error">&nbsp;</span><a id="forgetpwd" >忘记密码?<span class="tip">如忘记密码，只能将路由器复位。<br/>方法：连接电源，长按路由器上的WIFI/RST键约10秒后松开(注意：此操作将还原路由器所有设置，您需重新设置路由器才能上网)。</span></a></p>
