...
#define _LAN0_DNS			"lan_dns"  /* 添加lan dns server页面配置 z10312 20150609 */
...
//add by z1013 添加mac clone模式配置 20150605
#define _MACCLONEMODE 		"wan0_macclone_mode" 
...
/*Virtual Server*/
#define _VIRTUAL_SRV_IP				"portListIntranetIP"
#define _VIRTUAL_SRV_IN_PORT 		"portListIntranetPort"
#define _VIRTUAL_SRV_EX_PORT 		"portListExtranetPort"
#define _VIRTUAL_SRV_PORTO 		"portListProtocol"
...
/*ParentControl*/
#define PARENT_CONTROL_CLIENT_NUM		"parentCtl_client_num"
#define PARENT_CONTROL_CLIENT_LIST(i)		racat("parentCtl_client_list",i)		
#define PARENT_CONTROL_TIME				"parentCtl_time"
#define PARENT_CONTROL_DATE				"parentCtl_date"
#define PARENT_CONTROL_URL_FILTER_MODE	"parentCtl_urlFilter_mode"
#define PARENT_CONTROL_URL_FILTER_LIST	"parentCtl_urlFilter_list"

#define DEVICE_REMARK_NUM			"device_remark_num"
#define DEVICE_REMARK_LIST(i)		racat("device_remark_list",i)
...
#define WLN0_CTL_TIME_INTERVAL2			"wl_time_interval"
#define WLN0_CTL_TIME_WEEK2				"wl_time_week"
