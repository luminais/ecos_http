...
//var def_pin = "<%get_wireless_wps("dyn_wpspin","wps_device_pin");%>";
var changed = 0;
var old_MBSSID;
var SSID = new Array();
	...
	if (http_request.readyState == 4) {
		...
		if(mode == "disabled"){
			...
			if(wpsmethod == "pbc"){
			   ...
			   //document.getElementById("wpspin").style.display = "";
...
//function changeSecurityPolicyTableTitle2(t){
	//var title2 = document.getElementById("wpspin");
//title2.innerHTML = "路由器PIN码 -- " + "\"" + t+ "\"";
//}
//++++++++++++++++++stanley
function init(){
...
function onwifiuse(x){
	if(x==0 || mode == "disabled"){
	 ...
	 //document.getElementById("wpspin").style.display="none";
	 document.getElementById("rstOOB").disabled = true;
...
<BODY leftMargin=0 topMargin=0 MARGINHEIGHT="0" MARGINWIDTH="0" onLoad="init();" class="bg">
			...
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
				...
				<table cellpadding="0" cellspacing="0" class="content3" id="table1">
				  ...
				  <tr id="div_security_infra_mode" name="div_security_infra_mode"> 
					<td width="150" align="right" class="head">安全模式</td>
					<td>
    ...
    <td align="right" class="head">加密类型</td>
    <td>
...
<!-- WPA -->
				<table cellpadding="0" cellspacing="0" class="content1" id="div_wpa" style="margin-top:0px;" name="div_wpa">
				  ...
				  <tr id="div_wpa_algorithms" name="div_wpa_algorithms" style="visibility: visible;"> 
					<td width="150" align="right" class="head">WPA加密规则</td>
					<td>
...
-->				
				...
				<tbody>
					<tr  id="n3_wps_disabled" name="n3_wps_disabled" >
					  <td width="150" align="right" id="wpsWPS_text">WPS设置</td>
					  <td align="left">
				...
				<table cellpadding="0" cellspacing="0" class="content1" id="table3" style="margin-top:0px;">
				   <tr id="wifiuse_wps" name="wifiuse_wps" >
						<td width="150" align="right">WPS设置模式</td>
						<td width="120" nowrap="nowrap">
                        &nbsp;&nbsp;&nbsp;
					<input type="radio" name="wpsMode" value="pbc" onClick="onSel(2)">PBC&nbsp;&nbsp;<input type="radio" name="wpsMode" value="pin" onClick="onSel(1)">PIN</td>
						<td><input name="PIN" id="PIN" size="8" maxlength="8" class="text" type="text"></td>
                        </tr>
				<tr>
					<td colspan="3" align="left"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="wpspin"></span></td>
				</tr>
				</table>
