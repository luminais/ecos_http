	...
	<div id="main_content" class="container">
		<div id="sub_menu">
			<ul class="nav-list">
				...
				<li><a target="mainFrame" href="wireless_mode.asp">WAN Medium Type</a></li>
				<li><a target="mainFrame" href="lan.asp" >LAN Settings</a></li>
				<li><a target="mainFrame" href="wan_dns.asp">DNS Setting</a></li>
		...
		<div id="container">
			...
			<div id="container_main" class="container-main"></div>
			<div id="help">
