				...
				<table cellpadding="0" cellspacing="0" class="content1" id="table1">
					<tr><td height="30">&nbsp;&nbsp;<script>document.write(_("Time zone"));</script>: 
					  <select class="list" id="TZ">
						...
						<option value="13">(GMT-04:00)<script>document.write(_("Atlantic Time"));</script></option>                         
						<option value="14">(GMT-04:00)<script>document.write(_("Manaus"));</script></option>      
						<option value="15">(GMT-04:00)<script>document.write(_("Caracas, La Paz"));</script></option>                             
