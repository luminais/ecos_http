...
<table width="897" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="100" align="center" valign="bottom"><img src="qubee.jpg"></td>
      </tr>
    </table>
	...
	<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="basicset">
		<TR>
		  <TD width="160" align="right"><script>document.write(_("Access Method"));</script>:</TD>
	...
	<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="basicset">
		<TR>
		  <TD width="160" align="right"><script>document.write(_("Access Account"));</script>:</TD>
		  <TD align="left">&nbsp;&nbsp;<INPUT class=text1 maxLength=50 name=PUN id="PUN" size=25></TD>
		</TR>
		<TR>
		  <TD width="160" align="right"><script>document.write(_("Access Password"));</script>:</TD>
		  <TD align="left">&nbsp;&nbsp;<INPUT class=text1 maxLength=50 name=PPW id="PPW" size=25 type=text></TD>
		</TR>
	</table>
	</div>
	<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="basicset">
		<TR>
		  <TD align="center"><span class="STYLE2"><script>document.write(_("other access methods"));</script></span></TD>
		</TR>
	</table>
<hr width="50%" color="#dedfe1">
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" class="basicset">
  <tr>
    <td height="45" colspan="3" align="center" class="STYLE1"><script>document.write(_("Wireless encryption"));</script></td>
  </tr>
  <tr>
    <td width="160" align="right" valign="middle"><script>document.write(_("Wireless password"));</script>:</td>
