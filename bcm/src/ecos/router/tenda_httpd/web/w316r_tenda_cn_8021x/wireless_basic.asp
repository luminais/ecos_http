...
function init()
{
	document.wireless_basic.wl_mode.value = wl0_mode;
...
function changeWds(x)
{
	...
	else if(x==1)
	{
		 ...
		 document.getElementById("wdsMode_1").style.display = "none";
	}
}
/**/
...
function CheckValue()
{
	...
	var all_wds_list;
	all_wds_list = '';
	if (0)//(document.wireless_basic.WirelessT[1].checked==true)
	{
