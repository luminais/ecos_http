...
function tbl_tail_save_str(f)
{
	...
	m+="<input type=\"button\" class=\"button1\" value=\"确定\"   onMouseOver=\"style.color='#FF9933'\" onMouseOut=\"style.color='#000000'\" onClick=preSubmit("+f+")>&nbsp;&nbsp;&nbsp;&nbsp;";
...
function helpInfo(info)
{
	...
	m += '<tr><td align="center"><b>帮助信息</b></td></tr>';
