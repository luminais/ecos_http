...
function preSubmit(f) {
	if (!strCheck(f.HN,"主机名")) return;
	if (!strCheck(f.DN,"域名")) return;
...
<BODY leftMargin=0 topMargin=0 MARGINHEIGHT="0" MARGINWIDTH="0" onLoad="init(document.frmSetup);" class="bg">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
              ...
              <tr>
				...
				<table cellpadding="0" cellspacing="0" class="content3" id="table2">
					...
					<tr><td height="30" id="setTab">
						...
						<input type="text" class="text" id="hour" size="2" maxlength="2">时
		...
		<script>helpInfo('本页设置路由器的系统时间，您可以选择自己设置时间或者从互联网上获取标准的GMT时间，然后系统会自动连接NTP服务器进行时间同步。<br>&nbsp;&nbsp;&nbsp;&nbsp;注意：关闭路由器电源后，时间信息会丢失，当您下次开机连上Internet后，路由器将会自动获取GMT时间。您必须先连上Internet获取GMT时间或到此页设置时间后，其他功能（如防火墙）中的时间限定才能生效。'
		);</script>
