...
function tbl_tail_save_str(f)
{
	...
	m+="<input type=\"button\" class=\"button1\" value=\"確定\"   onMouseOver=\"style.color='#FF9933'\" onMouseOut=\"style.color='#000000'\" onClick=preSubmit("+f+")>&nbsp;&nbsp;&nbsp;&nbsp;";
	m+="<input type=\"button\" class=\"button1\" value=\"取消\"   onMouseOver=\"style.color='#FF9933'\" onMouseOut=\"style.color='#000000'\" onClick=init("+f+")>";
	m+='</td></tr></table>';
	return m;
}
...
function helpInfo(info)
{
	...
	m += '<tr><td align="center"><b>說明資訊</b></td></tr>';
	m += '<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;' + info +  '</td></tr>';
	m += '</table>';
