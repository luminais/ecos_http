...
statistic_list_ip_index_t stream__ip_iist[STREAM_CLIENT_NUMBER];
//end of hqw
...
#define TIMES 1
//#define ip_ubs(X) stream_ip[X].index->up_byte_pers
//#define ip_dbs(X) stream_ip[X].index->down_byte_pers
