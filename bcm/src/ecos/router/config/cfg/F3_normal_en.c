...
struct nvram_tuple router_defaults[] = {
	...
	{ "lan_dns", "192.168.0.1 8.8.8.8", 0 },	/* 添加lan dns server页面配置 z10312 20150609 */
...
/*roy midify*///{ "lan1_proto", "dhcp", 0 },		/* DHCP server [static|dhcp] */
	...
	{ "wan_mode_check_verdict","",0},/*gong add标记是否需要自动切换模式*/
	/*pptp*/
	...
	{ "http_passwd", "", 0 },		/* Password YWRtaW4=*/  
...
//N3没有WPS功能
	...
	{ "wl_time_interval","00:00-07:00",0},
...
/*归一化，家长控制*/
	...
	{"parentCtl_client_list11", "", 0},
	{"parentCtl_client_list12", "", 0},
	{"parentCtl_client_list13", "", 0},
	{"parentCtl_client_list14", "", 0},
	{"parentCtl_client_list15", "", 0},
	{"parentCtl_client_list16", "", 0},
	{"parentCtl_client_list17", "", 0},
	{"parentCtl_client_list18", "", 0},
	{"parentCtl_client_list19", "", 0},
	{"parentCtl_client_list20", "", 0},
	{"parentCtl_time", "19:00-21:00", 0},
	{"parentCtl_date", "11111111", 0},
