...
struct nvram_tuple router_defaults[] = {
	...
	{ "te_version", "cn", 0 },	 /* tenda revision */
	{ "os_language", "zh", 0 },	 /* language */
	...
	{ "never_prompt_pppoe", "0", 0 },		/* if 1,never prompt */
	{ "never_prompt_wlpwd", "0", 0 },		/* if 1,never prompt */
	...
	{ "clnway", "0", 0 },/*add for auto mac web page */
...
/*roy midify*///{ "lan1_proto", "dhcp", 0 },		/* DHCP server [static|dhcp] */
	...
	{ "lan1_route", "", 0 },			/* Static routes
						 ...
						 */
	/*sntp*/
	{ "ntp_server", "129.6.15.28 129.6.15.29 18.145.0.30 211.138.200.208", 0 }, /* NTP server */ 
	...
	{ "wan0_isonln","no",0},/*gong 标记能否上网*/
	{ "auto_clone_flag","yes",0},/*gong 标记是否需要在受到PADI时克隆mac地址*/
	...
	{ "wan0_dns","",0},
	{ "wan0_dns_fix","0",0},
	{ "static_wan0_mtu","1500",0}, /*static*/
	
	/*dhcp*/
	{ "wan0_hostname","Tenda",0}, /*dhcp only*/
	{ "wan0_mtu","1500",0}, /*dhcp || static*/
	{ "dhcp_wan0_mtu","1500",0}, /*dhcp*/

	/*pppoe*/
	{ "pppoe_wan0_mtu","1460",0}, /*pppoe*/
	{ "wan0_pppoe_prio_xkjs","0",0},/*add for pppoe xkjs,save the best one*/
	{ "wan0_pppoe_ifname","ppp0",0},/*read only*/
	{ "wan1_pppoe_ifname","ppp2",0},/*hqw add for wan pppoe检测*/
	{ "lan0_pppoe_ifname","ppp1",0},/*gong add for lan pppoe server*/
	{ "wan0_pppoe_username","",0},
	{ "wan0_pppoe_passwd","",0},
	{ "wan0_tmp_pppoe_username","",0},/*gong add for lan pppoe server*/
	{ "wan0_tmp_pppoe_passwd","",0},/*gong add for lan pppoe server*/

	{ "wan0_pppoe_ac","",0},
	{ "wan0_pppoe_service","",0},
	{ "wan0_pppoe_mtu","1460",0},
	{ "wan0_pppoe_mru","1460",0},
	{ "wan0_pppoe_demand","0",0},
	{ "wan0_pppoe_idletime","60",0},
	{ "wan0_pppoe_keepalive","1",0},
	{ "wan0_pppoe_st","0",0},
	{ "wan0_pppoe_et","0",0},
	//{ "onlncheck","yes",0},/*gong add标记是否需要检测能否上网*/
	{ "mode_need_switch","yes",0},/*gong add标记是否需要自动切换模式*/
	/*pptp*/
	...
	{ "tc_enable", "1", 0},			/*start stream control*/
	{ "tc_0", "", 0},
	{ "tc_1", "", 0},
	{ "tc_2", "", 0},
	{ "tc_3", "", 0},
	...
	{ "dhcp_end", "192.168.0.200", 0 },	/* Last assignable DHCP address */
	...
	{ "http_passwd", "", 0 },		/* Password */
	{ "http_defaultpwd", "", 0 },  /*产测添加为产测免COOKIE认证补丁*/
	{ "http_defaultpwd1", "0", 0 },  
	{ "http_passwd_tip", "", 0 },  
	{ "http_passwd_tip1", "0", 0 },  
...
//	{ "wl_frameburst", "on", 0},
	...
	{ "ht_bw_fake_auto", "1", 0},	/*for NH316,mark current bandwidth as fake 20/40*/
	{ "wl_nctrlsb", "upper", 0},		/* N-CTRL SB */
	{ "wl_nband", "2", 0},			/* N-BAND */
	...
	{ "wl_crypto", "", 0 },		/* WPA data encryption */
...
//N3没有WPS功能
	...
	{ "wl_wme_ap_be", "15 63 1 8192 8192 off off", 0 },		/* WME AP AC_BE parameters */
	...
	{ "sb/1/tempthresh", "115", 0 },
	/* WL device ID for 5357 */
	{ "sb/1/devid", "0x4347", 0},
...
//	{ "wl_wifictl_time_interval", "82800,86400;0,25200", 0 },
	/* 0:00 - 6:30 */
	{ "wl_wifictl_time_interval", "0,23400", 0 },
	{ "alilink_wlan_sche_listnum", "0", 0 },
	{ "alilink_wlan_offtime_list1", "UTC+08:00 0 0 0 ? * 1,2,3,4,5,6,7", 0},
	{ "alilink_wlan_ontime_list1", "UTC+08:00 0 30 6 ? * 1,2,3,4,5,6,7", 0},
#ifdef __CONFIG_ALINKGW__
	{ "alilink_wlan_offtime_list2", "", 0},
	{ "alilink_wlan_offtime_list3", "", 0},
	{ "alilink_wlan_offtime_list4", "", 0},
	{ "alilink_wlan_offtime_list5", "", 0},
	{ "alilink_wlan_offtime_list6", "", 0},
	{ "alilink_wlan_offtime_list7", "", 0},
	{ "alilink_wlan_offtime_list8", "", 0},
	{ "alilink_wlan_offtime_list9", "", 0},
	{ "alilink_wlan_offtime_list10", "", 0},
	{ "alilink_wlan_ontime_list2", "", 0},
	{ "alilink_wlan_ontime_list3", "", 0},
	{ "alilink_wlan_ontime_list4", "", 0},
	{ "alilink_wlan_ontime_list5", "", 0},
	{ "alilink_wlan_ontime_list6", "", 0},
	{ "alilink_wlan_ontime_list7", "", 0},
	{ "alilink_wlan_ontime_list8", "", 0},
	{ "alilink_wlan_ontime_list9", "", 0},
	{ "alilink_wlan_ontime_list10", "", 0},
	{ "ali_reset_bind", "0" , 0},
	{ "alilink_probed_switch", "1" , 0},
	{ "alilink_attack_switch", "1" , 0},
	{ "alilinkgw_enable", "1" , 0},
	{ "alilinkgw_sec_enable", "1" , 0},
#endif
	{ "wl_ctv_power","high",0},
	{ "wl_ctv_pwr_percent","100",0},
	{ "sb/1/interference","2",0},
	{ "sgi_tx","-1",0},
	{ "sgi_rx","3",0},	
	{ 0, 0, 0 }
};
