...
struct nvram_tuple router_defaults[] = {
	...
	{ "http_passwd", "YWRtaW4=", 0 },		/* Password */
	{ "http_defaultpwd", "YWRtaW4=", 0 },  /*产测添加为产测免COOKIE认证补丁*/
	{ "http_passwd_tip", "", 0 },		/* Password */
...
//	{ "wl_frameburst", "on", 0},
	...
	{ "wl_old_ssid", "Tenda", 0 },		/* Service set ID (network name) */
