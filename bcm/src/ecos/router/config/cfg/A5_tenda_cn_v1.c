...
struct nvram_tuple router_defaults[] = {
	...
	{ "lan_ipaddr", "192.168.2.1", 0 },	/* LAN IP address */
	{ "lan_netmask", "255.255.255.0", 0 },	/* LAN netmask */
	{ "lan_gateway", "192.168.2.1", 0 },	/* LAN gateway */
...
/*roy midify*///{ "lan1_proto", "dhcp", 0 },		/* DHCP server [static|dhcp] */
	...
	{"pppoe_index","0",0},
	{"config_index","0",0},
	{"wan0_check","0",0},   // pppoe<-->dhcp auto change 0:disable 1:enable
	...
	//{ "dhcp_en", "", 0},
	{ "dhcp_start", "192.168.2.100", 0 },	/* First assignable DHCP address */
	{ "dhcp_end", "192.168.2.150", 0 },	/* Last assignable DHCP address */
