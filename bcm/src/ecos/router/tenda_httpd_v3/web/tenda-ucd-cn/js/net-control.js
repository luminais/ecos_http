...
var pattern = /^\d*\.?\d+/,
	...
	function createTable() {
		...
		var thead = "<thead><tr><th>主机名称</th><th width='84px'>备注</th><th width='56px'>连接方式</th><th width='63px'>下载速度</th><th width='140px'>网速限制</th><th width='78px'>互联网访问</th></tr></thead>",
			tbody = "";
		if(navigator.vendor && navigator.vendor.indexOf('Apple') !== -1) {
			thead = "<thead><tr><th>主机名称</th><th width='96px'>备注</th><th width='68px'>连接方式</th><th width='75px'>下载速度</th><th width='152px'>网速限制</th><th width='90px'>互联网访问</th></tr></thead>";
		}
		if(len === 0) {
