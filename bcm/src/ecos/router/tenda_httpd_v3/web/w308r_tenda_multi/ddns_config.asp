...
function init(f){
	f.elements["serverName"].value=((parseInt(severnam)==0)?1:severnam);
              ...
              <tr>
				...
				<table cellpadding="0" cellspacing="0" class="content1" id="table1">
					...
					<td nowrap>
					  ...
					  <a class="content" href="#" onClick="reg()" style="color:#3366ff;"><script>document.write(_("Sign up"));</script></a></td>
					</tr>
					<tr>
