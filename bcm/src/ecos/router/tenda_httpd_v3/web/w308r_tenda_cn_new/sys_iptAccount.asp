...
<form name="iptAccountform" method=post action="/goform/iptAcount_mng">
	...
	<fieldset>
		<h2 class="legend">流量统计</h2>
		<div class="control-group">
			<label class="control-label">启用流量统计</label>
			<div class="controls">
				<label for="enableiptAccount" class="checkbox">
					<input id="enableiptAccount" name="enableiptAccount" value=1 type="checkbox" onClick='enable_Account()' />启用</label>
			</div>
		</div>
		<div id="div_iptAccountTable">
			<table class="table">
				<thead>
					<tr><td width="17%" align="center">IP 地址</td>
					<td width="14%" align="center">上行速率(KByte/s)</td>
					<td width="14%" align="center">下行速率(KByte/s)</td>
					<td width="15%" align="center">发送报文个数</td>
					<td width="12%" align="center">发送字节
					  <script>document.write(accountUnit);</script></td>
					<td width="15%" align="center">接收报文个数</td>
					<td width="12%" align="center">接收字节
					  <script>document.write(accountUnit);</script></td>
					</tr>
				</thead>
