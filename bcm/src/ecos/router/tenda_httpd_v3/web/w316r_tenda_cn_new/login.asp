	...
	<div class="container login">
		<form name="Login" method="post" action="/LoginCheck">
			...
			<div id="submitOperation" class="btn-group">
				<input type="button" value="确 定" class="btn btn-link" onMouseOver="style.color='#FF9933'" onMouseOut="style.color='#000000'" onClick="preSubmit(document.Login)">
				<input type="reset" value="取 消" class="btn btn-link" onMouseOver="style.color='#FF9933'" onMouseOut="style.color='#000000'">
			</div>
		</form>
	</div>
</body>
