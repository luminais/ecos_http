...
<BODY leftMargin=0 topMargin=0 MARGINHEIGHT="0" MARGINWIDTH="0" onLoad="init();" class="bg">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
            ...
            <td align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
                <tr>
				  ...
				  <form name="iptAccountform" method=post action=/goform/iptAcount_mng>
					...
					<script>document.write(_("Enable  traffic statistics"));</script><input type="hidden" name="enableiptAccountEx" /></div><br >
					...
					<table cellpadding="1" cellspacing="0" border="1" class="content1" id="table1" style="margin-top:0px; width:85%;">
						<thead style="height:24px; text-align:center;" valign="middle">
							<tr style="line-height:20px;">
								<td width="11%" align="center"><script>document.write(_("IP address"));</script></td>
								<td width="16%" align="center"><script>document.write(_("Uplink rate"));</script>(KByte/s)</td>
								<td width="16%" align="center"><script>document.write(_("Downlink rate"));</script>(KByte/s)</td>
								<td width="17%" align="center"><script>document.write(_("Sent message"));</script></td>
								<td width="12%" align="center"><script>document.write(_("Sent Bytes"));</script>
								  <script>document.write(accountUnit);</script></td>
								<td width="17%" align="center"><script>document.write(_("Received message"));</script></td>
								<td width="11%" align="center"><script>document.write(_("Received Bytes"));</script>
								  <script>document.write(accountUnit);</script></td>
							</tr>
						</thead>
		...
		<script>helpInfo(_("traffic statistics function enables viewing each computer's traffic information"));</script>	
		</td>
      </tr>
    </table>
