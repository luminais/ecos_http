...
<body>
	<form method=post name="wireless_mode" action="/goform/setUniversalRepeater" >
		<input type="hidden" id="wl_mode" name="wl_mode" />
		<fieldset class="table-field">
			<legend>Universal Repeater</legend>
			<div class="control-group">
				<label class="control-label">Settings</label>
				<div class="controls">
					<label class="radio"><input type="radio" name="wlMode" checked="checked" value="0" onClick="onWlMode('ap')" />Disable</label>
					<label class="radio"><input type="radio" name="wlMode" value="1" onClick="onWlMode('wet')" />Enable</label>
				</div>
			</div>
			<div id="wl_wan_note" style="display:none;">
			<p class="text-red" style=" padding-top:10px; padding-bottom:5px;">Complete below settings to connect to AP.</p>
			<div  class="control-group">
			...
			<div  class="control-group">
				...
				<div class="controls">
					...
					<script>
						document.write('<option value=' + 0 + '>' + "AutoSelect" + '</option>');
						for(var i=1;i<12; i++) {
		...
		<table id="wdsScanTab" class="table table-fixed" style="display:none">
			<thead>
				<tr>
				  <th width="10%" class="fixed"><div align="center">Select</div></td>
				  <th width="25%" class="fixed"><div align="center">SSID</div></td>
				  <th width="25%" class="fixed"><p align="center">MAC Address</p></td>
				  <th width="11%" class="fixed"><div align="center">Channel</div></td>
				  <th width="15%" class="fixed"><div align="center">Security</div></td>
...
<script type="text/javascript" src="js/wireless_apclient.js"></script>
</body>
</html> 