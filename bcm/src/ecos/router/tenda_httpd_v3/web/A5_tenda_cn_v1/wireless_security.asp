...
<!--	wps not used on N3	/A5		
				<hr style="width:75%">
-->				
				<table cellpadding="0" cellspacing="0" class="content1" id="table2" style="margin-top:0px;" style="visibility: hidden;">
				<input type=hidden name=wifiEn>
				<input type=hidden name=wpsmethod>
				<tbody>
					<tr  id="n3_wps_disabled" name="n3_wps_disabled"  style="visibility: hidden;">
				...
				<table cellpadding="0" class="content1" id="table3" style="margin-top:0px;"   style="visibility:hidden;">
				   <tr id="wifiuse_wps" name="wifiuse_wps"   style="visibility:hidden;">
				...
				<table class="content1" style="margin-top:0px;"  style="visibility:hidden;">
				...
				无线安全设置<br>
				802.11n 标准只定义了Open-None（Disable）,WPA-个人-AES,WPA2-个人-AES这 3种标准加密模式,其它加密方式为非标准,不同厂商之间可能会有兼容性问题。
				<br>Tenda对无线加密进行了优化，选择WPA中AES加密方式，可有效防止蹭网。
				</span><br>
				</td></tr>
				</table>
