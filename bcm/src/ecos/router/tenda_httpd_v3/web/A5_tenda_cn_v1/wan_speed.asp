                ...
                <tr>
				  ...
				  <form name="wanspeed" method=post action=/goform/setWanSpeed>
					...
					<table cellpadding="1" cellspacing="0" border="0" class="content1" style="margin-top:0px; width:80%;">
						<tr><td align="left">&nbsp;&nbsp;&nbsp;&nbsp;WAN速率选择:</td></tr>
					</table>
					<table cellpadding="1" cellspacing="0" border="0" class="content1" id="table1" style="margin-top:0px; width:80%;">
						<tr><td width="20%" align="left"><input type="radio" name="ws" value="0">自动协商</td>
							<td width="20%" align="left"><input type="radio" name="ws" value="1">10M半双工</td>
							<td width="20%" align="left"><input type="radio" name="ws" value="2">10M全双工</td>
							<td width="20%" align="left"><input type="radio" name="ws" value="3">100M半双工</td>
							<td width="20%" align="left"><input type="radio" name="ws" value="4">100M全双工</td>
						</tr>
					</table>
					</div><br >
					<SCRIPT>
