...
<title>Wirelee | Basic Settings</title>
...
//把SSID 和信道改成和对方一样
					document.forms[0].elements["ssid"].value = decodeSSID(ssid);
            ...
            <td align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
                <tr>
                  <td align="center" valign="top">
					...
					<div id="divwieless_en" style="display:none; margin:0px; padding:0px;">
					<table border="0" cellpadding="0" cellspacing="0" class="content2">
					<tr style="visibility:hidden;"><td width="30%" valign="top"><input type="checkbox" name="enablewireless"  value="1" id="enablewireless"onClick="onenablewirelesschange()">启用无线功能
					...
					<table class="content1" id="table1" style="margin-top:0px;" cellpadding="0" cellspacing="0">
					  <tr id="wireless_mode_a5v1" name="wireless_mode_a5v1" style="visibility:hidden;">
					    <td width="100" align="right">无线工作模式</td>
					    <td>&nbsp;&nbsp;&nbsp;&nbsp;<INPUT name=WirelessT type=radio value=0 onClick="changeWds(0);">无线接入点(AP)&nbsp;<INPUT name=WirelessT type=radio value=1 onClick="changeWds(1);">网桥(WDS)</td>
					    </tr>
					  <tr> 
					...
					<div id="div_wmm">
					<hr style="width:75%;">
					<table name="div_wmm" id="table2" cellspacing="0" cellpadding="0" class="content1" style="margin-top:0px;">
...
<!---->
					...
					<div style="width:442; height:1px; background-color:#c0c7cd; overflow:hidden; padding:0px; margin-top:1px;"></div>	
					  ...
					  <tr id="wds_mac_list_1" name="wds_mac_list_1" style="visibility:visible;">
						...
						<td align="left" width="342">&nbsp;&nbsp;&nbsp;&nbsp;<input type=text name=wds_1 size=20 maxlength=17 value=""><input type="hidden" name="ssid_1"><input type="hidden" name="schannel_1"></td>
					  </tr>
					...
					选择网桥(WDS)模式时，SSID、信道将自动设置成和对端AP的一样。</span><br>
					</td></tr>
