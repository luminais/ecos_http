		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<table width="100%" height="21" border="0" align="center" cellpadding="0" cellspacing="0" id="submenu1" class="submenu" style="display:block;">
              <tr>
                <td height="21" valign="top">&nbsp;&nbsp;<a href="system_status.asp" style="color:#3366ff;" target="mainFrame" onclick=MenuClick(event);>系统状态</a>&nbsp;&nbsp;<a href="wan_connected.asp" target="mainFrame" onclick=MenuClick(event);>WAN口设置</a>&nbsp;&nbsp;<a href="lan.asp" target="mainFrame" onclick=MenuClick(event);>LAN口设置</a>&nbsp;&nbsp;<a href="mac_clone.asp" target="mainFrame" onclick=MenuClick(event);>MAC克隆</a>&nbsp;&nbsp;<a href="wan_dns.asp" target="mainFrame" onclick=MenuClick(event);>DNS设置</a>&nbsp;&nbsp;<a href="wireless_mode.asp" target="mainFrame" onclick=MenuClick(event);>WAN介质类型</a>&nbsp;&nbsp;<a href="net_tc.asp" target="mainFrame" onclick=MenuClick(event);>带宽控制</a>&nbsp;&nbsp;<a href="sys_iptAccount.asp" target="mainFrame" onclick=MenuClick(event);>流量统计</a>&nbsp;&nbsp;<a href="wan_speed.asp" target="mainFrame" onclick=MenuClick(event);>WAN速率控制</a></td>
              </tr>
            </table>
