...
'wireless_signal.asp',
	'<p>' + _("This page allows you to select wireless signal strength modes: Common Mode or Enhanced Mode. The default mode is Enhanced Mode."),
'wireless_control.asp',
	'<p>' + _("This page allows you to enable/disable your WiFi during your specified time. This feature is disabled by default. 24-hour clock is used here."),
'wireless_extra.asp',
	'<p>' + _("Wireless_apclient_helpinfo1") + '</p>' +
	'<p><em>' + _("Universal Repeater") + ':</em>' + _("Wireless_apclient_helpinfo2") + '</p>' +
	'<p><em>' + _("WISP Mode") + ':</em>' + _("Wireless_apclient_helpinfo3") + '</p>' +
	'<p><em>' + _("WDS Bridge Mode") + ':</em>' + _("Wireless_apclient_helpinfo4") + '</p>' +
	'<p><em>' + _("Open Scan") + ':</em>' + _("Wireless_apclient_helpinfo5") + '</p>',
'lan_dhcps.asp',
...
menuObj["advance"] 	= ["system_status.asp;" + _("Status"), "wan_connected.asp;" + _("Internet Connection Setup"),
		"mac_clone.asp;" + _("MAC Clone"), "wan_speed.asp;" + _("WAN Speed"), "lan.asp;" + _("LAN Settings"),
...
menuObj["wireless"] = ["wireless_basic.asp;" + _("Wireless Basic Settings"),
		...
		"wireless_extra.asp;" + _("Wireless Extender")];
...
if(highPower){
	menuObj["wireless"] = ["wireless_basic.asp;" + _("Wireless Basic Settings"),
		"wireless_security.asp;" + _("Wireless Security"),
		"wireless_control.asp;" + _("Wireless Schedule"),
		"wireless_filter.asp;" + _("Access Control"), "wireless_state.asp;" + _("Wireless Connection Status"),
		"wireless_extra.asp;" + _("Wireless Extender"),
		"wireless_signal.asp;" + _("Wireless Signal")];
}