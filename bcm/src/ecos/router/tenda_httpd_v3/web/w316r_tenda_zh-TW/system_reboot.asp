...
function preSubmit() {
	if(window.confirm("大約50秒後，系統會重新連結至首頁。"))
	{	
...
<BODY leftMargin=0 topMargin=0 MARGINHEIGHT="0" MARGINWIDTH="0" onLoad="init(document.frmSetup);" class="bg">
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
          ...
          <tr>
			...
			<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
              <tr>
			    ...
			    <tr><td colspan=2 valign="top">&nbsp;&nbsp;點選此按鈕將使路由器重新啟動。</td>
			    </tr>
				</table>
				<table cellpadding="0" cellspacing="0" class="content3" id="table1">
					<tr><td width="30%">
					&nbsp;&nbsp;<input class="button2" onClick="preSubmit()" value="重新啟動路由器" type="button" onMouseOver="style.color='#FF9933'" onMouseOut="style.color='#000000'"  id="rebootBtn">
		...
		<script>
		helpInfo('重新啟動路由器將使您之前所改變的設定生效。在重新啟動時，所有的網路連線都會中斷，點選「確定」即可重新啟動。');
		</script>
