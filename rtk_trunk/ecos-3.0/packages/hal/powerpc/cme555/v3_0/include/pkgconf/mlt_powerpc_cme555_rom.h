...
#define CYGMEM_REGION_ram_SIZE    (0x07ffff)
...
#define CYGMEM_REGION_eflash_SIZE (0x07ffff)
...
#define CYGMEM_SECTION_heap1_SIZE (0x00480000 - (size_t) CYG_LABEL_NAME (__heap1))
