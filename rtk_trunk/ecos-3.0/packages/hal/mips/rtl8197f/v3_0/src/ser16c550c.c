...
//      ser16c550c.c
//
//      Simple driver for the 16c550c serial controllers on the rtl8xxx board
//
//=============================================================================
...
//-----------------------------------------------------------------------------
// Define the serial registers. The rtl8xxx board is equipped with a 16550C
// serial chip.
...
//#define CYG_DEV_SERIAL_BAUD_DIVISOR (RTL819X_SER_CLOCK/(16*CYGNUM_HAL_VIRTUAL_VECTOR_CHANNELS_DEFAULT_BAUD)-1)
#define CYG_DEV_SERIAL_BAUD_DIVISOR (RTL819X_SER_CLOCK/(16*CYGNUM_HAL_VIRTUAL_VECTOR_CHANNELS_DEFAULT_BAUD))


#undef CYGARC_HAL_SAVE_GP()
#define CYGARC_HAL_SAVE_GP()

#undef CYGARC_HAL_RESTORE_GP() 
...
static channel_data_t channels[1] = {
    { (cyg_uint8*)RTL819X_SER_16550_BASE_A, 1000, CYGNUM_HAL_INTERRUPT_UART0},
};
...
cyg_hal_plf_serial_control(void *__ch_data, __comm_control_cmd_t __func, ...)
{
    ...
    case __COMMCTL_SETBAUD:
    {
        ...
        //baud_divisor = (RTL819X_SER_CLOCK / (16 * baud_rate) - 1);
        baud_divisor = (RTL819X_SER_CLOCK / (16 * baud_rate));
