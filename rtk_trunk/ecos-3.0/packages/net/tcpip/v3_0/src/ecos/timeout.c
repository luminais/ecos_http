...
/* 
 * Realtek porting, 2011/02/23
 * If FREEBSD_TIMEOUT_C is defined, do_timeout(), timeout() and untimeout() use
 * the implementation of FreeBSD stack.
 */
#define FREEBSD_TIMEOUT_C
#ifdef FREEBSD_TIMEOUT_C
...
void callout_reset(struct callout *c, int delta, timeout_fun *f, void *p);
