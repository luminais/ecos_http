...
// Description: The following code is used to cli command of thread, Ported by zhuhuan on 2015.12.24
// +++++
cyg_handle_t fd_thread[CYGNUM_FILEIO_NFD];
// +++++
 ...
 * Function name: cyg_fd_thread_dump
 * Description: The following function is used to cli command of thread
 * Date: 2015.12.24
 */
 // +++++
__externC void cyg_fd_thread_dump(cyg_handle_t *fd_thread_list)
{
    FILEIO_MUTEX_LOCK(fdlock);

    memcpy(fd_thread_list, fd_thread, sizeof(fd_thread));
