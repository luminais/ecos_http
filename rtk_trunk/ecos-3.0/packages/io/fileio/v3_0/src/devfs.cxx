...
{
/*lq modify */
    cyg_devtab_entry *t = (cyg_devtab_entry_t *)fp->f_data;
    if (t->handlers && t->handlers->ioctl)
        return (*t->handlers->ioctl)((cyg_io_handle_t)t, com, data);
    return ENOSYS;
}
...
/*lq modify */
    ...
    cyg_devtab_entry_t *t = (cyg_devtab_entry_t *)fp->f_data;
    if (t->handlers && t->handlers->close)
        error = (*t->handlers->close)((cyg_io_handle_t)t);
    fp->f_data = 0;
    return error;
}
