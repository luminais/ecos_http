...
typedef struct {
    ...
    /* word 0 */
     unsigned long        intIPAddr;
    /* word 1 */
    unsigned int          reserv0     : 1;
    unsigned int          selEIdx     : 10;
    unsigned int          selIPIdx    : 4;
    unsigned int          isStatic    : 1;
    unsigned int          dedicate    : 1;
    unsigned int          collision2  : 1;
    unsigned int          offset      : 6;
    unsigned int          agingTime   : 6;
    ...
    unsigned int          TCPFlag     : 3;
    unsigned int          intPort     : 16;
#else /*_LITTLE_ENDIAN*/
    /* word 0 */
     unsigned long        intIPAddr;
    /* word 1 */
