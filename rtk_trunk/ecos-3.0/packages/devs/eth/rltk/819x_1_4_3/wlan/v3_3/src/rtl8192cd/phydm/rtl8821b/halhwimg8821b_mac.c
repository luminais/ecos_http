...
void
ODM_ReadAndConfig_MP_8821B_MAC_REG(
 	IN   PDM_ODM_T  pDM_Odm
 	)
{
    ...
    #define COND_ENDIF 3
    u4Byte     i         = 0;
    u4Byte     ArrayLen    = sizeof(Array_MP_8821B_MAC_REG)/sizeof(u4Byte);
    pu4Byte    Array       = Array_MP_8821B_MAC_REG;
	
    ODM_RT_TRACE(pDM_Odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> ODM_ReadAndConfig_MP_8821B_MAC_REG\n"));
    ...
    for (i = 0; i < ArrayLen; i += 2 )
    {
        ...
        if ( v1 < 0x40000000 )
        {
           odm_ConfigMAC_8821B(pDM_Odm, v1, (u1Byte)v2);
           continue;
        }
        else
...
u4Byte
ODM_GetVersion_MP_8821B_MAC_REG(
)
{
	   return 14;
}
