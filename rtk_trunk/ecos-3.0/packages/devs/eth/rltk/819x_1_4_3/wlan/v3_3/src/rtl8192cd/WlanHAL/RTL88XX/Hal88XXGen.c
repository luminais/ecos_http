    ...
    if ( IS_HARDWARE_TYPE_8822B(Adapter) ) {
		if (IS_HAL_TEST_CHIP(Adapter)) {
			...
			*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioA_8822B_hp_start;
			...
			if ((GET_CHIP_VER_8822(Adapter)==1) &&(HAL_RFE_TYPE == 1)){ //8822 B-cut & type1
				printk("[%s][RadioA_8822Bmp_hp_Ver1_Type1]\n",__FUNCTION__);
				*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioA_8822Bmp_hp_Ver1_Type1_start;
			}else if (GET_CHIP_VER_8822(Adapter)==2){ //8822 C-cut
				if(HAL_RFE_TYPE == 1){
					printk("[%s][RadioA_8822Bmp_hp_Ver2_Type1]\n",__FUNCTION__);
					*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioA_8822Bmp_hp_Ver2_Type1_start;
				}else if (HAL_RFE_TYPE == 6){
					printk("[%s][RadioA_8822Bmp_hp_Ver2_Type6]\n",__FUNCTION__);
					*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioA_8822Bmp_hp_Ver2_Type6_start;
				}else if (HAL_RFE_TYPE == 7){
					printk("[%s][RadioA_8822Bmp_hp_Ver2_Type7]\n",__FUNCTION__);
					*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioA_8822Bmp_hp_Ver2_Type7_start;
				}
			}else{		
        ...
        if ( IS_HARDWARE_TYPE_8822B(Adapter) ) {
			if (IS_HAL_TEST_CHIP(Adapter)) {
				...
				*((pu4Byte)(val)) = (u4Byte)(data_RadioA_8822B_hp_end - data_RadioA_8822B_hp_start);
				...
				if ((GET_CHIP_VER_8822(Adapter)==1)&&(HAL_RFE_TYPE == 1)){ //8822 B-cut & type1
					*((pu4Byte)(val)) = (u4Byte)(data_RadioA_8822Bmp_hp_Ver1_Type1_end - data_RadioA_8822Bmp_hp_Ver1_Type1_start);
				}else if (GET_CHIP_VER_8822(Adapter)==2){//8822 c-cut
					if(HAL_RFE_TYPE == 1)
						*((pu4Byte)(val)) = (u4Byte)(data_RadioA_8822Bmp_hp_Ver2_Type1_end - data_RadioA_8822Bmp_hp_Ver2_Type1_start);
					else if(HAL_RFE_TYPE == 6)
						*((pu4Byte)(val)) = (u4Byte)(data_RadioA_8822Bmp_hp_Ver2_Type6_end - data_RadioA_8822Bmp_hp_Ver2_Type6_start);
					else if(HAL_RFE_TYPE == 7) 
						*((pu4Byte)(val)) = (u4Byte)(data_RadioA_8822Bmp_hp_Ver2_Type7_end - data_RadioA_8822Bmp_hp_Ver2_Type7_start);
				}else
        ...
        if ( IS_HARDWARE_TYPE_8822B(Adapter) ) {
			if (IS_HAL_TEST_CHIP(Adapter)) {
                ...
                *((dma_addr_t*)(val)) = (dma_addr_t)data_RadioB_8822B_hp_start;
				...
				if ((GET_CHIP_VER_8822(Adapter)==1) &&(HAL_RFE_TYPE == 1)){ //8822 B-cut & type1
					printk("[%s][RadioB_8822Bmp_hp_Ver1_Type1]\n",__FUNCTION__);
					*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioB_8822Bmp_hp_Ver1_Type1_start;
				}else if (GET_CHIP_VER_8822(Adapter)==2){ //8822 C-cut
					if(HAL_RFE_TYPE == 1){
						printk("[%s][RadioB_8822Bmp_hp_Ver2_Type1]\n",__FUNCTION__);
						*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioB_8822Bmp_hp_Ver2_Type1_start;
					}else if (HAL_RFE_TYPE == 6){
						printk("[%s][RadioB_8822Bmp_hp_Ver2_Type6]\n",__FUNCTION__);
						*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioB_8822Bmp_hp_Ver2_Type6_start;
					}else if (HAL_RFE_TYPE == 7){
						printk("[%s][RadioB_8822Bmp_hp_Ver2_Type7]\n",__FUNCTION__);
						*((dma_addr_t*)(val)) = (dma_addr_t)data_RadioB_8822Bmp_hp_Ver2_Type7_start;
					}
				}else{		
        ...
        if ( IS_HARDWARE_TYPE_8822B(Adapter) ) {
			if (IS_HAL_TEST_CHIP(Adapter)) {
				*((pu4Byte)(val)) = (u4Byte)(data_RadioB_8822B_hp_end - data_RadioB_8822B_hp_start);
				...
				if ((GET_CHIP_VER_8822(Adapter)==1)&&(HAL_RFE_TYPE == 1)){ //8822 B-cut & type1
					*((pu4Byte)(val)) = (u4Byte)(data_RadioB_8822Bmp_hp_Ver1_Type1_end - data_RadioB_8822Bmp_hp_Ver1_Type1_start);
				}else if (GET_CHIP_VER_8822(Adapter)==2){//8822 c-cut
					if(HAL_RFE_TYPE == 1)
						*((pu4Byte)(val)) = (u4Byte)(data_RadioB_8822Bmp_hp_Ver2_Type1_end - data_RadioB_8822Bmp_hp_Ver2_Type1_start);
					else if(HAL_RFE_TYPE == 6)
						*((pu4Byte)(val)) = (u4Byte)(data_RadioB_8822Bmp_hp_Ver2_Type6_end - data_RadioB_8822Bmp_hp_Ver2_Type6_start);
					else if(HAL_RFE_TYPE == 7) 
						*((pu4Byte)(val)) = (u4Byte)(data_RadioB_8822Bmp_hp_Ver2_Type7_end - data_RadioB_8822Bmp_hp_Ver2_Type7_start);
				}else
