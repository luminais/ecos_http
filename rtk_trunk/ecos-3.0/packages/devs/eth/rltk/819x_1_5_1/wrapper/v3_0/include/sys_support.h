...
#define _constant_cpu_to_le16(x)	(x)
#define __constant_htons(x) (cpu_to_be16(x))
...
//#define _dma_cache_wback_inv(addr, size) do {} while(0)
#define dma_cache_wback_inv(addr, size)	_dma_cache_wback_inv(addr, size)


#define _dma_cache_inv(addr, size) HAL_DCACHE_INVALIDATE(addr, size)
//#define _dma_cache_inv(addr, size) do {} while(0)
#define dma_cache_inv(addr, size)	_dma_cache_inv(addr, size)


#define _dma_cache_wback(addr, size) HAL_DCACHE_FLUSH(addr, size)
#define dma_cache_wback(addr, size) _dma_cache_wback(addr, size)
