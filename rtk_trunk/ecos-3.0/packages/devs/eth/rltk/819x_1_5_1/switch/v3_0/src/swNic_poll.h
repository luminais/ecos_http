...
* All rights reserved.
* 
* $Header: /cvs/AP/rtl865x/linux-2.4.18/drivers/net/rtl865x/swNic_poll.h,v 1.11 2010/01/18 07:04:11 joeylin Exp $
*
...
__MIPS16 int32 swNic_receive(void** input, uint32* pLen, unsigned int *vid, unsigned int *pid);
//int32 swNic_send(void * output, uint32 len);
__MIPS16 int32 swNic_send(void *skb, void * output, uint32 len, unsigned int vid, unsigned int pid);
