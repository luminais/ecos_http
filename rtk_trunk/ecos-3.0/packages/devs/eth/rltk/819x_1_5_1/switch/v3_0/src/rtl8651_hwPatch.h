...
#if defined(CONFIG_RTL8196B) || defined(CONFIG_RTL8196C) || defined(CONFIG_RTL8198) || defined(CONFIG_RTL_819XD) || defined(CONFIG_RTL_8196E) || defined(CONFIG_RTL_8881A) ||defined(CONFIG_RTL_8197F)
#define RTL865X_TLU_BUG_FIXED				1
#define RTL865X_PHY6_DSP_BUG				0
#define RTL865X_IP_MCAST_NEW_HASH		1		
#else
