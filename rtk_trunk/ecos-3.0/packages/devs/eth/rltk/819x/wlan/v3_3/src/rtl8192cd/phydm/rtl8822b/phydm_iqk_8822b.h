...
#define 	BB_REG_NUM_8822B 12
#define 	RF_REG_NUM_8822B 3


#define	LOK_delay_8822B 100
#define	IQK_delay_8822B 100
#define	WBIQK_delay_8822B 100
...
#define PHY_IQCalibrate_8822B(_pDM_VOID, _bReCovery)
