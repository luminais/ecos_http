...
#if (defined(CONFIG_RTL_88E_SUPPORT) && defined(TXREPORT)) || defined(CONFIG_RTL_8812_SUPPORT) || defined(CONFIG_WLAN_HAL_8881A) || defined(CONFIG_WLAN_HAL_8192EE) || defined(CONFIG_WLAN_HAL_8814AE) || defined(CONFIG_RTL_8723B_SUPPORT) 
...
__PACK struct rf_misc_info {
	...
	s1Byte				mimosq[4];
	s1Byte				RxSNRdB[4];
#if ( defined(CONFIG_WLAN_HAL_8822B) || defined(CONFIG_WLAN_HAL_8197F))
	u1Byte				RxCount:2;
	u1Byte				BandWidth:2;
	u1Byte				rxsc:4
#else
