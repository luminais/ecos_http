...
/*#define DIG_VERSION	"1.12"	2015.09.07  Stanley, DIG always write IGI of all path for 8814A*/
/*#define DIG_VERSION	"1.13"	2015.09.23  YuChen, add reset ofdm cca and FA setting*/
/*#define DIG_VERSION	"1.14"	2015.10.12  Stanley, Modify big jump step for 8822B when writing IGI, Remove dummy code*/
#define DIG_VERSION	"1.15"	/* 2015.11.06  Stanley, Modify big jump step for 8822B when writing IGI*/
