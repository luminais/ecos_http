...
#ifndef CONFIG_NEW_IGMP_IMPLEMENTATION
#define CONFIG_NEW_IGMP_IMPLEMENTATION
#endif
...
#define DEFAULT_MAX_GROUP_COUNT					     32	         /* default max group entry count **/
#define DEFAULT_MAX_SOURCE_COUNT                     32         /*default max source entry count*/
