...
#endif
//#define RTL_IGMPSNOOPING_DEBUG 1

#ifdef __KERNEL__
	#if defined RTL_IGMPSNOOPING_DEBUG
	#define rtl_gluePrintf(fmt, args...) printk(fmt, ## args)
	#else
	#define rtl_gluePrintf(fmt, args...)
	#endif
#else
	#if defined RTL_IGMPSNOOPING_DEBUG
	#define rtl_gluePrintf(fmt, args...) printf(fmt, ## args)
	#else
	#define rtl_gluePrintf(fmt, args...) 
	#endif
#endif
