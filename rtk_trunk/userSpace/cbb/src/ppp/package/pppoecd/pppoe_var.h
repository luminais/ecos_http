...
#include "../../../../../net_drive/include/net/pppoe.h"
...
#define PPPOE_MAXNAMELEN		512
#define PPPOE_MAXSECRETLEN		512
...
struct pppoe_param {
	...
	char username[PPPOE_MAXNAMELEN];
	char password[PPPOE_MAXSECRETLEN];
