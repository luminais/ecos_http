...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context.
 */
void lmMD5Update (context, input, inputLen)
MD5_CONTEXT *context;                                        /* context */
 ...
 */
void lmMD5Final (digest, context)
...
*/
  ...
  lmMD5Update (context, PADDING, padLen);

  /* Append length (before padding) */
  lmMD5Update (context, bits, 8);
