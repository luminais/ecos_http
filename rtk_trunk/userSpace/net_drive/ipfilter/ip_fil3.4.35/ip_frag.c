...
# if defined(_KERNEL) && !defined(__sgi) && !defined(__ECOS)
...
# if (defined(KERNEL) || defined(_KERNEL)) && !defined(__ECOS)
#  ifndef IPFILTER_LKM
...
static const char rcsid[] = "@(#)$Id: ip_frag.c,v 1.4 2010-08-25 10:20:46 Exp $";
#endif
...
extern void ip_autofwexpire(void);
