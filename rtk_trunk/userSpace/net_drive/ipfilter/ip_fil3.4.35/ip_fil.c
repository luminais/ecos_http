...
# define	_KERNEL
#endif
#if defined(_KERNEL) && defined(__FreeBSD_version) && (__FreeBSD_version >= 400000) && \
	!defined(KLD_MODULE)
#include "opt_inet6.h"
#endif
#include <sys/param.h>
...
#include <sys/file.h>
#endif
#if __FreeBSD_version >= 220000 && defined(_KERNEL) && !defined(__ECOS)
# include <sys/fcntl.h>
# include <sys/filio.h>
#else
# include <sys/ioctl.h>
...
static const char rcsid[] = "@(#)$Id: ip_fil.c,v 1.2 2010-05-05 11:43:46 Exp $";
#endif
...
#if (__FreeBSD_version >= 300000) && defined(_KERNEL) && !defined(__ECOS)
...
#if defined(__NetBSD__) && (__NetBSD_Version__ >= 106080000) && defined(_KERNEL)
# include <sys/conf.h>
...
#  else
#   if ((__FreeBSD_version >= 300000) || defined(__sgi)) && !defined(__ECOS)
...
{
	int s, i;
#if defined(NETBSD_PF) && ((__NetBSD_Version__ >= 104200000) || (__FreeBSD_version >= \
	500011))
	int error = 0;
...
# else
#  if (__FreeBSD_version >= 300000) && !defined(__ECOS)
...
# if (defined(_KERNEL) && ((_BSDI_VERSION >= 199510) || (BSD >= 199506) || (NetBSD >= \
	199511) || (__FreeBSD_version >= 220000) || defined(__OpenBSD__)) && !defined(__ECOS))
, p)
struct proc *p;
# else
)
...
dev_t dev;
# if defined(__NetBSD__) || defined(__OpenBSD__) || (_BSDI_VERSION >= 199701) || \
	((__FreeBSD_version >= 300000) && !defined(__ECOS))
u_long cmd;
# else
int cmd;
# endif
...
# if defined(__NetBSD__) || (defined(__OpenBSD__) && (OpenBSD >= 200012))
...
# if !defined(IPFILTER_LKM) && !defined(__sgi) && (!defined(__FreeBSD_version) || \
	(__FreeBSD_version < 300000) || defined(__ECOS))
#  if	(BSD < 199306)
...
# ifndef sparc
#  if (!defined(__FreeBSD__) && !(_BSDI_VERSION >= 199510)) && !(__NetBSD_Version__ >= \
	105110000)
...
// cwu  - need to use the new route struct.
