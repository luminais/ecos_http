...
# include <ctype.h>
# if SOLARIS || defined(__NetBSD__) || defined(_BSDI_VERSION) || defined(__sgi)
#  ifdef ERR
#   undef ERR
#  endif
#  include <curses.h>
...
static const char rcsid[] = "@(#)$Id: fils.c,v 1.1.1.1 2010-04-30 02:12:04 Exp $";
#endif
...
char *argv[];
{
	...
	while ((c = getopt(argc, argv, "6aACfghIilnoqstvd:D:M:N:P:S:T:")) != -1)
	{
		...
		case 'P' :
			...
			} else if (!sscanf(optarg, "%lu", &protocol) ||
					   (protocol < 0)) {
