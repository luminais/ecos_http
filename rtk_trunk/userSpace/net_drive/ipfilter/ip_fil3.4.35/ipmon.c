...
static const char rcsid[] = "@(#)$Id: ipmon.c,v 1.1.1.1 2010-04-30 02:12:03 Exp $";
#endif
...
int	blen;
{
	...
	*t = '\0';
	...
	(defined(__FreeBSD__) && (__FreeBSD_version >= 501113)) || (defined(OpenBSD) && \
	(OpenBSD >= 199603))) || defined(linux)
	{
