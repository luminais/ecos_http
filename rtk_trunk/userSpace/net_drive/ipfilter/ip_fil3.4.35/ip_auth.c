...
#if (defined(_KERNEL) || defined(KERNEL)) && !defined(linux) && !defined(__ECOS)
# include <sys/systm.h>
#endif
...
#if !defined(lint)
static const char rcsid[] = "@(#)$Id: ip_auth.c,v 1.2 2010-05-05 11:43:46 Exp $";
#endif
...
{
	mb_t *m;
#if defined(_KERNEL) && !SOLARIS && (!defined(__FreeBSD_version) || (__FreeBSD_version \
	< 501000))
	struct ifqueue *ifq;
	int s;
#endif
...
#  if ((_BSDI_VERSION >= 199802) && (_BSDI_VERSION < 200005)) || defined(__OpenBSD__) \
	|| (defined(IRIX) && (IRIX >= 605)) || (__FreeBSD_version >= 470102)
