		...
		val: function (val) {
			...
			return this.each(function () {
				if (this.value !== "undefined") {
					this.value = val;
					//for ie8 placeholder
					if (REasy(this).parent().length > 0 && REasy(this).parent().find(".placeholder-content").length === 1) {
						if (REasy(this).parent().find("#" + this.id + "_").length === 1) {
							REasy(this).parent().find("#" + this.id + "_")[0].value = val;
							REasy(this).parent().find("#" + this.id + "_").css("display", "none");
						}
						REasy(this).parent().find(".placeholder-content").css("display", 'none');
