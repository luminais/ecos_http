...
%.o: %.c
	$(XCC) -c -o $*.o $(CFLAGS) $(EXTRA_CFLAGS) $(DEBUG_CFLAGS) $(CFLAGS_$@) $<

%.o: %.cxx
	$(XCXX) -c -o $*.o $(CFLAGS) $(EXTRA_CFLAGS) $(DEBUG_CFLAGS) $(CFLAGS_$@) $<
...
%.o: %.S
	$(XCXX) -c -o $*.o $(CFLAGS) $(EXTRA_CFLAGS) $(DEBUG_CFLAGS) $(CFLAGS_$@) -D__GNU_ASM__ $<
