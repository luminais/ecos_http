...
//#if BITS_PER_LONG == 32
unsigned int __attribute__((weak)) __div64_32(__uint64_t *n, unsigned int base)
{
	__uint64_t rem = *n;
	__uint64_t b = base;
	__uint64_t res, d = 1;
...
static char * number(char * str, __uint64_t num, int base, int size, int precision, int type)
{
	char c,sign,tmp[66];
