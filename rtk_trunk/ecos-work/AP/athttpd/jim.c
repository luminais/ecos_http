...
void DupSourceInternalRep(Jim_Interp *interp, Jim_Obj *srcPtr, Jim_Obj *dupPtr)
{
    ...
    dupPtr->internalRep.sourceValue.lineNumber =
        srcPtr->internalRep.sourceValue.lineNumber;
...
{
    Jim_Obj *varObjPtr=NULL, *keyObjPtr=NULL, *dictObjPtr=NULL, *resObjPtr=NULL;
        ...
        Jim_Obj *const *argv)
{
...
#ifdef JIM_OPTIMIZATION
    {
		...
		if(NULL == expr)	return JIM_ERR;
		if(NULL == incrScript) return JIM_ERR;
