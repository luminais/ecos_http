...
// HF Patch
CYG_HTTPD_AUTH_TABLE_ENTRY(web_whole_dir,WEB_ROOT,WEB_ROOT,cyg_httpd_userName,cyg_httpd_passwd,CYG_HTTPD_AUTH_BASIC);
// HF patch End
...
char cyg_httpd_userName[USERNAME_LEN]=DUMMY_STRING;
char cyg_httpd_passwd[USERNAME_LEN]=DUMMY_STRING;
char b64string[] =
