...
#define DHCPC_THREAD_PRIORITY 16
//#define DHCPC_THREAD_STACK_SIZE 0x00004000
#define DHCPC_THREAD_STACK_SIZE 0x00002000
...
#define CYGOPT_NET_DHCP_OPTION_HOST_NAME 
#define CYGNUM_NET_DHCP_OPTION_HOST_NAME_LEN 32
...
#define TAG_CLASSLESS_STATIC_ROUTE 	((unsigned char)  121)
/* classless static route for MS */
#define TAG_MS_CLASSLESS_STATIC_ROUTE 	((unsigned char)  249)
#endif
struct dhcp_lease {
...
#define DFLTDHCPLEN sizeof(struct bootp)
#endif

//extern int do_dhcp(const char *interface, struct bootp *res,
//        cyg_uint8 *pstate, struct dhcp_lease *lease);
extern int do_dhcp(cyg_addrword_t data);
