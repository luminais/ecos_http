...
/*
	Secure Socket apis
*/
extern int			sslConnect(sslConn_t **cp, SOCKET fd, sslKeys_t *keys, sslSessionId_t *id, short cipherSuite, int (*certValidator)(sslCertInfo_t *t, void *arg), void *cb_data );
