...
int AuthDecWPA2KeyData(Supp_Global* pGlobal, u_char *key, int keylen, u_char *kek, int keklen, u_char *kout)
{
	int	retVal = 0;
	u_char	default_key_iv[] = { 0xA6,0xA6,0xA6,0xA6,0xA6,0xA6,0xA6,0xA6 };
	u_char 	tmp2[257];
...
failure.
*/
int AuthDecGTK(OCTET_STRING EAPOLMsgRecvd, u_char *kek, int keklen, int keylen,
u_char *kout)
{
	int		retVal = 0;
